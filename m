...
Received: from mail.librecores.org (lists.librecores.org [88.198.125.70])
	by mail.lfdr.de (Postfix) with ESMTP id D2D6867FA7B
	for <lists+openrisc@lfdr.de>; Sat, 28 Jan 2023 20:37:04 +0100 (CET)
Received: from [172.31.1.100] (localhost.localdomain [127.0.0.1])
	by mail.librecores.org (Postfix) with ESMTP id 4E505229C5;
	Sat, 28 Jan 2023 20:37:04 +0100 (CET)
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
 by mail.librecores.org (Postfix) with ESMTPS id 5281A20022
 for <openrisc@lists.librecores.org>; Sat, 28 Jan 2023 20:37:02 +0100 (CET)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by dfw.source.kernel.org (Postfix) with ESMTPS id 3BFAE615B9;
 Wed, 25 Jan 2023 19:08:52 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8D840C433A8;
 Wed, 25 Jan 2023 19:08:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1674673732;
 bh=9Hb0l03elrJwF5xXHPVNpA2WTY5MR1mMy9/nTivyxAk=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Mike Rapoport <rppt@kernel.org>
To: Andrew Morton <akpm@linux-foundation.org>
Subject: [PATCH 3/3] mm,
 arch: add generic implementation of pfn_valid() for FLATMEM
Date: Wed, 25 Jan 2023 21:07:57 +0200
Message-Id: <20230125190757.22555-4-rppt@kernel.org>
