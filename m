...
Received: from mail.librecores.org (lists.librecores.org [88.198.125.70])
	by mail.lfdr.de (Postfix) with ESMTP id 7235F23D36B
	for <lists+openrisc@lfdr.de>; Wed,  5 Aug 2020 23:08:03 +0200 (CEST)
Received: from [172.31.1.100] (localhost.localdomain [127.0.0.1])
	by mail.librecores.org (Postfix) with ESMTP id 4961020DB7;
	Wed,  5 Aug 2020 23:08:03 +0200 (CEST)
Received: from mail-pg1-f196.google.com (mail-pg1-f196.google.com
 [209.85.215.196])
 by mail.librecores.org (Postfix) with ESMTPS id 6283120DA7
 for <openrisc@lists.librecores.org>; Wed,  5 Aug 2020 23:08:01 +0200 (CEST)
Received: by mail-pg1-f196.google.com with SMTP id p3so25379694pgh.3
 for <openrisc@lists.librecores.org>; Wed, 05 Aug 2020 14:08:01 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=emsoU0j9Bl5DmKGC3Jly3v8Cf8b0+9+ogMOi2z5kCao=;
 b=
X-Gm-Message-State: AOAM530fUV444eFdeRQTq2O0QE8cXv11k7YsAzIzruiAS5wC+ZfgLOSj
 EvJi3p2GUu231te2EQGxtJA=
...
MIME-Version: 1.0
Subject: [OpenRISC] [PATCH v2 5/6] openrisc: signal: Fix sparse address
 space warnings
